...
$(document).ready(function(){
     $('body,html').animate({scrollTop: 956}, 800); 
});
</script>
...
$myfile = fopen("data/mailad/".$ids.".mail", "r") or die("error!");
...
$source = file("data/mailad/".$ids.".mail");
// Đếm array $source có bao nhiêu phần tử
$lines = count($source);   
// In giá trị ra màn hình
if ($lines >= "30") {
	//echo 'gioi han 5';
	$my_file21 = "data/mailad/".$ids.".mail";
...
?>
<div class="otohit" id="otohit"></div>
</div>
<style>
