...
<form action="" method="post" class="w3-container">
	 <input type="text"  class="w3-input" name="msg" value="" placeholder="Nội dung tin nhắn"><br><br>
  <input type="submit" class="w3-btn w3-teal" name="send" value="Gửi">
  <input type="submit" class="w3-btn w3-light-green" name="sendad" value="Gửi tới ADMIN">
</form>
<?php
...
$msgg = $_POST['msg'];
$content = $_GET["u"]." : ".$msgg."\n";
$handle = fopen ("chatr-".$_GET['sv'].".radio","a");
fwrite ($handle, $content);  
 } elseif(isset($_POST['sendad'])){
$msgg = $_POST['msg'];
$content = $_GET["u"]." : ".$msgg."\n";
$handle = fopen ("data/mailad/".$_GET['u'].".mail","a");
fwrite ($handle, $content);  
$uuu = $_GET["u"];
$doge = "";
 }
...
?>
	<div style="<?php echo $doge; ?>">

<b>Email tới ADMIN:</b>
<a href="javascript: var a = window.open( '/mailads.php?u=<?php echo $_GET['u']; ?>', 'New tab', '' )"><img src="/images/mail.ico" width="50px"></a>
